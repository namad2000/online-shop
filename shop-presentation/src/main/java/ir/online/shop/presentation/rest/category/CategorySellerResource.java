...
//public class CategorySellerResource {
//
//    private final CategoryQueryUseCase categoryQueryUseCase;
//    private final CategoryQueryMapper categoryMapper;
//
//    @GetMapping("/available")
//    public PageResult<CategoryResponse> getAvailableCategories(
//            @RequestParam(defaultValue = "0") Integer pageNum,
//            @RequestParam(defaultValue = "10") Integer pageSize) {
//        return categoryMapper.toResponseList(
//                categoryQueryUseCase.getActiveCategories(PaginationRequest.of(pageNum, pageSize)), 1
//        );
//    }
//
//    @GetMapping("/search")
...
//            @RequestParam(defaultValue = "10") Integer pageSize) {
//        return categoryMapper.toResponseList(
//                categoryQueryUseCase.searchActive(name, PaginationRequest.of(pageNum, pageSize)), 1
//        );
//    }
//}
